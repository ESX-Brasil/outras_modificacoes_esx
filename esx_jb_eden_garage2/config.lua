...
Config.Garages = {
	Garage_Centre = {
		...
		SpawnPoint = {
			...
			HelpPrompt = "Pressione ~INPUT_PICKUP~ para tira seu veículo",
			Functionmenu = ListVehiclesMenu,
		},
		DeletePoint = {
			Pos = {x=215.124, y=-791.377, z=30.646},
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = "Pressione ~INPUT_PICKUP~ para retornar o seu veículo",
...
Config.GaragesMecano = {
	Bennys = {
		Name = 'Patio do Mecanico',
		SpawnPoint = {
			Pos = {x = 477.729,y = -1888.856,z = 26.094},
			Heading = 303.0,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = "Pressione ~INPUT_PICKUP~ para sair um veículo apreendido",
			Functionmenu = ListVehiclesFourriereMenu,
		},
		DeletePoint = {
			Pos = {x = 459.733,y = -1890.335,z = 25.776},
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = "Pressione ~INPUT_PICKUP~ para devolver o veículo apreendido",
			Functionmenu = StockVehicleFourriereMenu,
		},
	},
	police = {
		Name = 'Patio da Policia',
		SpawnPoint = {
